...
ThinkReader 0.9.42 提供 Windows x64 版本，当前二进制文件未签名。

- [Windows 安装版](https://github.com/zhangzejing/ThinkReader/releases/download/v0.9.42/ThinkReader-Setup-0.9.42-win_x64.exe)
- [Windows 便携版](https://github.com/zhangzejing/ThinkReader/releases/download/v0.9.42/ThinkReader-0.9.42-win_x64.exe)
- [Windows ZIP 压缩包](https://github.com/zhangzejing/ThinkReader/releases/download/v0.9.42/ThinkReader-0.9.42-win_x64.zip)
- [发布说明](https://github.com/zhangzejing/ThinkReader/releases/tag/v0.9.42)
